...
public class MainActivity extends AppCompatActivity {
    ...
    private long addNewGuest(String name, int partySize) {
        ...
        value.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, name);
        value.put(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE, partySize);
        return mDb.insert(WaitlistContract.WaitlistEntry.TABLE_NAME, null, value);
