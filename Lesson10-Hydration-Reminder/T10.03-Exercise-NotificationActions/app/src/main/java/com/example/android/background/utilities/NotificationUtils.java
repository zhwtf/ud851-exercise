...
public class NotificationUtils {
    ...
    private static Action ignoreReminderAction(Context context) {
        ...
        PendingIntent ignoreReminderPendingIntent = PendingIntent.getActivity(context,
    ...
    private static Action drinkWaterAction(Context context) {
        ...
        PendingIntent incrementWaterPendingIntent = PendingIntent.getActivity(context,
                ACTION_DRINK_PENDING_INTENT_ID, incrementWaterCountIntent, PendingIntent.FLAG_UPDATE_CURRENT);
